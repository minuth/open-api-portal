...
export const IconEyeOff = ({ width = 14, height = 14, class: className = 'btn-icon', ...rest }: IconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const IconUnlock = ({ width = 14, height = 14, class: className = 'btn-icon', ...rest }: IconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const IconShare = ({ width = 14, height = 14, class: className = 'btn-icon', ...rest }: IconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const IconLink = ({ width = 14, height = 14, class: className = 'btn-icon', ...rest }: IconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const IconChevronDown = ({ width = 14, height = 14, class: className = 'btn-icon', ...rest }: IconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
